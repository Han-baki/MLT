--------------------------------------------------------------------------------------------------------------
ICDAR2019 MLT data text detection & language classification 의 keras기반 학습 코드입니다. 
...
tbpp_train.ipynb 파일의 각 code cell들의 맨 위에, page0부터 page5로 주석을 달았습니다. 
...
page0에 있는 것이 input입니다. input에 다음과 같이 집어넣어주고 run all을 누르면 학습이 전부 진행되게 했습니다.
